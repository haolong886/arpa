...
C6accel_Handle C6accel_create(String engName, Engine_Handle hEngine,String algName, UNIVERSAL_Handle hUni)
{
  ...
  if (hEngine == NULL){
    ...
    hC6accel->callType = SYNC;

    return hC6accel;
}

/* Enable Asynchronous calling by setting callType variable to ASYNC */
Int C6Accel_setAsync(C6accel_Handle hC6accel)
{
    hC6accel->callType = ASYNC;
...

{
    ...
    Int                         status;
    /* Define pointer to function parameter structure */
    gen_twiddle_fft16x16_Params *fp0;
    //int                         outRet[1];
    XDAS_Int8                   *pAlloc;
    ...
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(gen_twiddle_fft16x16_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
    ...
    /* Fill in input/output buffer descriptor parameters and manage ARM cache*/
    /* See wrapper_c6accel_i.h for more details of operation                 */
     CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(ptr_w,0,2*n*sizeof(short));
    ...
    /* Initialize the extended InArgs structure */
    CInArgs->fxn[0].FxnID     = DSP_GEN_TWIDDLE_FFT16x16_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset = sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Set function Id and parameter pointers for first function call */
    fp0 = (gen_twiddle_fft16x16_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
    /* Fill in the fields in the parameter structure */
    fp0->n           = n;
    fp0->twiddle_OutArrID1 = OUTBUF0;
...

{
    ...
    Int                         status;
    /* Define pointer to function parameter structure */
    gen_twiddle_fft32x32_Params *fp0;
    //int                         outRet[1];
    XDAS_Int8                   *pAlloc;
    ...
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(gen_twiddle_fft32x32_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
    ...
    /* Fill in input/output buffer descriptor parameters and manage ARM cache*/
    /* See wrapper_c6accel_i.h for more details of operation                 */
     CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(ptr_w,0,2*n*sizeof(int));
    ...
    /* Initialize the extended InArgs structure */
    CInArgs->fxn[0].FxnID     = DSP_GEN_TWIDDLE_FFT32x32_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset = sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Set function Id and parameter pointers for first function call */
    fp0 = (gen_twiddle_fft32x32_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
    /* Fill in the fields in the parameter structure */
    fp0->n           = n;
    fp0->twiddle_OutArrID1 = OUTBUF0;
    fp0->scale       = scale;
...
)
{
    ...
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(IMG_yc_demux_be8_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
    ...
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(yc,0,2*n*sizeof(char));
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(y,0,n*sizeof(char));
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(cb,1,n/2*sizeof(char));
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(cr,2,n/2*sizeof(char));
    ...
    /* Set function Id and parameter pointers for first function call */
    CInArgs->fxn[0].FxnID= IMG_YC_DEMUX_BE8_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset=sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Initialize pointers to function parameters */
    fp0 = (IMG_yc_demux_be8_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
...

{
    ...
    /* Fill in input/output buffer descriptor parameters and manage ARM cache*/
    /* See wrapper_c6accel_i.h for more details of operation                 */
     CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(ptr_w,0,2*n*sizeof(float));
    ...
    /* Initialize the extended InArgs structure */
    CInArgs->fxn[0].FxnID     = DSPF_TW_GEN_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset = sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Set function Id and parameter pointers for first function call */
    fp0 = (tw_gen_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
    /* Fill in the fields in the parameter structure */
    fp0->n           = n;
    fp0->tw_OutArrID1 = OUTBUF0;
...

{
    ...
    /* Fill in input/output buffer descriptor parameters and manage ARM cache*/
    /* See wrapper_c6accel_i.h for more details of operation                 */
     CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(ptr_f,0,n*sizeof(float));
     CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(ptr_d,0,n*sizeof(double));
    ...
    /* Initialize the extended InArgs structure */
    CInArgs->fxn[0].FxnID     = MATH_F2D_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset = sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Set function Id and parameter pointers for first function call */
    fp0 = (f2d_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
    /* Fill in the fields in the parameter structure */
    fp0->n           = n;
    fp0->d_OutArrID1 = OUTBUF0;
    fp0->f_InArrID1  = INBUF0;
...
)
{
    ...
    /* Fill in input/output buffer descriptor parameters */
     ...
     CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(ptr_y,1,npoints*sizeof(float));
...
/*added by haolong 20130201*/
Int  C6accel_DSPF_arpa_a_b_filter(C6accel_Handle hC6accel,
                            int       *a,
                            int       *b,
                            unsigned int size_a,
                            unsigned int size_b
)
{
    ...
    /* Fill in input/output buffer descriptor parameters */
     CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(a,0,size_a);
//	 CACHE_WB_INV_INPUT_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(a,0,size_a);
     CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(b,0,size_b);
    ...
    /* Set function Id and parameter pointers for first function call */
    CInArgs->fxn[0].FxnID     = DSPF_ARPA_A_B_FILTER_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset = sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Initialize pointers to function parameters */
    fp0 = (arpa_a_b_filter_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);

    /* Fill in the fields in the parameter structure */
    fp0->a_InArrID1 =  INBUF0;
    fp0->b_OutArrID1 =  OUTBUF0;
    fp0->size_a =  size_a;
	fp0->size_b = size_b;
    printf("&&&&&&&&&--inapi-a=%x--&&&&&&&&&&&\n", *(int *)inBufDesc.descs[0].buf);
    printf("&&&&&&&&&--inapi-b=%x--&&&&&&&&&&&\n", *(int *)outBufDesc.descs[0].buf);
    /* Call the actual algorithm */
    if (hC6accel->callType == ASYNC)
      {
       /* Update async structure */ 
...
Int C6accel_IMG_ycbcr420pl_to_ycbcr422sp(
    C6accel_Handle hC6accel,
    const unsigned char * y_dst,    
    const unsigned char * cbcr_dst, 
    unsigned char * restrict y_src,
...
)
{
    ...
    Int                         status;
    /* Define pointer to function parameter structure */
    IMG_ycbcr420pl_to_ycbcr422sp_Params *fp0;
    XDAS_Int8                    *pAlloc;
    ...
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(cbcr_dst,1,num_lines*dst_pitch*sizeof(unsigned char));
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL( y_src,0,num_lines*src_y_pitch*sizeof(unsigned char));
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(cb_src,1,num_lines*src_cbcr_pitch/2*sizeof(unsigned char));
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(cr_src,2,num_lines*src_cbcr_pitch/2*sizeof(unsigned char));
  
    /* Allocate the InArgs structure as it varies in size
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(IMG_ycbcr420pl_to_ycbcr422sp_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
   ...
   /* Set function Id and parameter pointers for first function call */
    CInArgs->fxn[0].FxnID= IMG_YCBCR420PL_TO_YCBCR422SP_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset=sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Initialize pointers to function parameters */
    fp0 = (IMG_ycbcr420pl_to_ycbcr422sp_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
...
) 
{
    ...
    /* Fill in input/output buffer descriptor parameters */
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(dst,0,2*count*sizeof(unsigned char));
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(src,0,count*sizeof(unsigned char));
   ...
   /* Set function Id and parameter pointers for first function call */
    CInArgs->fxn[0].FxnID= IMG_RGB_Y_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset=sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);
