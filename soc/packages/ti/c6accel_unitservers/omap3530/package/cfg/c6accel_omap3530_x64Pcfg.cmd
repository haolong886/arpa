...
MEMORY {
   ...
   DDRALGHEAP  : origin = 0x88900000,  len = 0x900000
   DDR2        : origin = 0x89200000,  len = 0x300000
   DSPLINKMEM  : origin = 0x88801000,  len = 0xff000
   RESET_VECTOR : origin = 0x88800000, len = 0x1000
